...
import 'package:bsc_app/hebergement/ui/reservation_page.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: (){
          Navigator.of(context).push(MaterialPageRoute(builder: (context)=>ReservationPage(heberge: heberge)));
        },
        child: Card(
